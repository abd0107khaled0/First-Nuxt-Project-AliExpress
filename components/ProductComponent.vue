<template>
  <div>
    <div
      :id="product.id"
      class="bg-red-100 inline-block rounded hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)] w-full pb-2"
    >
      <NuxtLink :to="`/item/${product.id}`">
        <img :src="product.url" :alt="product.url" class="rounded-t" />
        <div id="ProductDetails">
          ...
          <span
            class="px-1 relative -top-1 text-[#ff6674] text-xs font-semibold"
          >
            Extra 5% off
          </span>
          ...
          <p class="px-1 pb-1">
            <span class="text-[#09A66] text-xs font-semibold">Free Shopping</span>
          </p>
        </div>
      </NuxtLink>
    </div>
